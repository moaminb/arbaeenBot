...
export default function UserPortal() {
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col rtl" dir="rtl">
      {/* Header */}
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 pt-24 max-w-4xl mx-auto w-full">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-100 mb-4">عکس‌های خود را پیدا کنید</h2>
          <p className="text-gray-400 text-lg">شماره موبایلی که به ربات داده‌اید را وارد کنید تا عکس‌هایتان را دریافت کنید.</p>
        </div>

        {/* Search Box */}
        <div className="w-full max-w-xl glass-card rounded-3xl p-6 relative z-10 mb-12 shadow-[0_0_50px_rgba(239,68,68,0.05)] border-white/10">
          ...
          <div className="w-full animate-fade-in">
            {photos.length > 0 ? (
              <>
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
                  ...
                  <h3 className="text-xl font-bold text-gray-100">
                    <span className="text-red-400">{photos.length}</span> عکس برای شما پیدا شد
                  </h3>
                </div>
              ...
              <div className="glass-card rounded-3xl p-12 text-center border-dashed border-2 border-white/10">
                ...
                <h3 className="text-xl font-bold text-gray-300 mb-2">عکسی یافت نشد!</h3>
                <p className="text-gray-500">متاسفانه با این شماره عکسی در سیستم ثبت نشده است.</p>
              </div>
            )}
          </div>
        )}
