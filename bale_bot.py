...
if not TOKEN:
    print("Error: BALE_BOT_TOKEN not found in .env file.")
    exit(1)
...
STRINGS = {
    'fa': {
        ...
        'ask_phone': "از توضیحات شما سپاسگزاریم.\nاکنون لطفاً جهت دریافت تصویر، شماره تلفن همراه خود را همراه با کد کشور وارد نمایید (مثال: +989123456789):",
        'ask_phone_skipped': "لطفاً جهت دریافت تصویر، شماره تلفن همراه خود را همراه با کد کشور وارد نمایید (مثال: +989123456789):",
